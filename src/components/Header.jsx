            ...
            <NavigationMenu>
              <NavigationMenuList>
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent className="z-[60] bg-card border border-border rounded-md shadow-xl data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 duration-200">
